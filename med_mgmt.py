...
def open_win(): #OPENS MAIN MENU----------------------------------------------------------------------------MAIN MENU
    ...
    apt=Tk()
    apt.title("Interface")
    Label(apt, text="KERALA PHARMACY").grid(row=0,column=0,columnspan=3)
    ...
    Button(apt,text='New Valued Customer', width=25, command=val_cus).grid(row=4,column=0)
...
def again():    #for login window-----------------------------------------------------------------------------LOGIN WINDOW
    ...
    root=Tk()
    root.title('VTTC')
    Label(root,text='KERALA PHARMACY').grid(row=0,column=0,columnspan=5)
    Label(root,text="PACE Mangalore ").grid(row=1,column=0,columnspan=5)
...
def open_cus(): #OPENS MAIN MENU----------------------------------------------------------------------------MAIN MENU
    ...
    apt=Tk()
    apt.title("Interface")
    Label(apt, text=" KERALA PHARMACY").grid(row=0,column=0)
